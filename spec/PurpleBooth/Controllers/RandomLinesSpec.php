...
class RandomLinesSpec extends ObjectBehavior
{
    ...
    function let($config, $multipleRandomLines, $app)
    {
    ...
    function it_has_api_action_that_returns_json()
    {
        $this->configMock->getLinesPerApiCall()->willReturn(2);
        $this->multipleLinesMock->getLines(2)->willReturn(array("Marmite", "Marmalade"));
